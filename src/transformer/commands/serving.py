...
from transformer.pipelines import SUPPORTED_TASKS, pipeline
...
logger = logging.getLogger("transformer-cli/serving")
    ...
    def __init__(self, pipeline: Pipeline, host: str, port: int, workers: int):
        ...
        if not _serve_dependencies_installed:
            raise RuntimeError(
                ...
                'Please install transformer with [serving]: pip install "transformer[serving]".'
