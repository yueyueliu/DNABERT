...
from transformer import SingleSentenceClassificationProcessor as Processor
from transformer import TextClassificationPipeline, is_tf_available, is_torch_available
...
class TrainCommand(BaseTransformersCLICommand):
    ...
    def __init__(self, args: Namespace):
        self.logger = getLogger("transformer-cli/training")
