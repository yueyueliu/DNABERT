...
class DistilBertConfig(PretrainedConfig):
    r"""
        This is the configuration class to store the configuration of a :class:`~transformer.DistilBertModel`.
        ...
        Example::
            ...
            from transformer import DistilBertModel, DistilBertConfig
