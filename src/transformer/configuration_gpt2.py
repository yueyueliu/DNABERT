...
class GPT2Config(PretrainedConfig):
    """
        This is the configuration class to store the configuration of a :class:`~transformer.GPT2Model`.
        ...
        Args:
            vocab_size (:obj:`int`, optional, defaults to 50257):
                ...
                can be represented by the `inputs_ids` passed to the forward method of :class:`~transformer.GPT2Model`.
            ...
            summary_type (:obj:`string`, optional, defaults to "cls_index"):
                ...
                :class:`~transformer.GPT2DoubleHeadsModel`.
        ...
        Example::
            ...
            from transformer import GPT2Model, GPT2Config
