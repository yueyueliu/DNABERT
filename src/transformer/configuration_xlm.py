...
class XLMConfig(PretrainedConfig):
    """
        This is the configuration class to store the configuration of a :class:`~transformer.XLMModel`.
        ...
        Args:
            vocab_size (:obj:`int`, optional, defaults to 30145):
                ...
                can be represented by the `inputs_ids` passed to the forward method of :class:`~transformer.XLMModel`.
            ...
            summary_type (:obj:`string`, optional, defaults to "first"):
                ...
                :class:`~transformer.XLMForSequenceClassification`.
        ...
        Example::
            ...
            from transformer import XLMConfig, XLMModel
