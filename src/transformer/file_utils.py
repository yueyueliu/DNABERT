...
default_cache_path = os.path.join(torch_cache_home, "transformer")
...
def add_start_docstrings_to_callable(*docstr):
    def docstring_decorator(fn):
        class_name = ":class:`~transformer.{}`".format(fn.__qualname__.split(".")[0])
...
def http_get(url, temp_file, proxies=None, resume_size=0, user_agent=None):
    ua = "transformer/{}; python/{}".format(__version__, sys.version.split()[0])
