...
from transformer.configuration_albert import AlbertConfig
from transformer.modeling_bert import ACT2FN, BertEmbeddings, BertSelfAttention, prune_linear_layer
...
ALBERT_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~transformer.AlbertConfig`): Model configuration class with all the parameters of the model.
...
ALBERT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`transformer.AlbertTokenizer`.
...
class AlbertModel(AlbertPreTrainedModel):
    ...
    def forward(
        ...
        r"""
    Return:
        :obj:`tuple(torch.FloatTensor)` comprising various elements depending on the configuration (:class:`~transformer.AlbertConfig`) and inputs:
    ...
    Example::
        ...
        from transformer import AlbertModel, AlbertTokenizer
        import torch
...
class AlbertForMaskedLM(AlbertPreTrainedModel):
    ...
    Example::
        ...
        from transformer import AlbertTokenizer, AlbertForMaskedLM
        import torch
...
class AlbertForSequenceClassification(AlbertPreTrainedModel):
    ...
    Returns:
        ...
        Examples::
            ...
            from transformer import AlbertTokenizer, AlbertForSequenceClassification
            import torch
...
class AlbertForQuestionAnswering(AlbertPreTrainedModel):
    ...
    Examples::
        ...
        from transformer import AlbertTokenizer, AlbertForQuestionAnswering
        import torch
