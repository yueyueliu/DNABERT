...
CTRL_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformer.CTRLConfig`): Model configuration class with all the parameters of the model.
...
CTRL_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`transformer.CTRLTokenizer`.
...
class CTRLModel(CTRLPreTrainedModel):
    ...
    def forward(
        ...
        r"""
    Return:
        :obj:`tuple(torch.FloatTensor)` comprising various elements depending on the configuration (:class:`~transformer.CTRLConfig`) and inputs:
    ...
    Examples::
        ...
        from transformer import CTRLTokenizer, CTRLModel
        import torch
...
class CTRLLMHeadModel(CTRLPreTrainedModel):
    ...
    Examples::
        ...
        import torch
        from transformer import CTRLTokenizer, CTRLLMHeadModel
