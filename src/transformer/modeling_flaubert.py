...
FLAUBERT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformer.FlaubertConfig`): Model configuration class with all the parameters of the model.
...
class FlaubertModel(XLMModel):
    ...
    def forward(
        ...
        r"""
    Return:
        :obj:`tuple(torch.FloatTensor)` comprising various elements depending on the configuration (:class:`~transformer.XLMConfig`) and inputs:
...
class FlaubertWithLMHeadModel(XLMWithLMHeadModel):
    """
    This class overrides :class:`~transformer.XLMWithLMHeadModel`. Please check the
...
class FlaubertForSequenceClassification(XLMForSequenceClassification):
    """
    This class overrides :class:`~transformer.XLMForSequenceClassification`. Please check the
    superclass for the appropriate documentation alongside usage examples.
    """
...
class FlaubertForQuestionAnsweringSimple(XLMForQuestionAnsweringSimple):
    """
    This class overrides :class:`~transformer.XLMForQuestionAnsweringSimple`. Please check the
    superclass for the appropriate documentation alongside usage examples.
    """
...
class FlaubertForQuestionAnswering(XLMForQuestionAnswering):
    """
    This class overrides :class:`~transformer.XLMForQuestionAnswering`. Please check the
    superclass for the appropriate documentation alongside usage examples.
    """
