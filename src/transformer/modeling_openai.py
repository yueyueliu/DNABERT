...
OPENAI_GPT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformer.OpenAIGPTConfig`): Model configuration class with all the parameters of the model.
...
OPENAI_GPT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`transformer.OpenAIGPTTokenizer`.
...
class OpenAIGPTModel(OpenAIGPTPreTrainedModel):
    ...
    def forward(
        ...
        r"""
    Return:
        :obj:`tuple(torch.FloatTensor)` comprising various elements depending on the configuration (:class:`~transformer.OpenAIGPTConfig`) and inputs:
    ...
    Examples::
        ...
        from transformer import OpenAIGPTTokenizer, OpenAIGPTModel
        import torch
...
class OpenAIGPTLMHeadModel(OpenAIGPTPreTrainedModel):
    ...
    Examples::
        ...
        from transformer import OpenAIGPTTokenizer, OpenAIGPTLMHeadModel
        import torch
...
class OpenAIGPTDoubleHeadsModel(OpenAIGPTPreTrainedModel):
    ...
    Examples::
        ...
        from transformer import OpenAIGPTTokenizer, OpenAIGPTDoubleHeadsModel
        import torch
