...
class TFAlbertModel(TFAlbertPreTrainedModel):
    ...
    def call(self, inputs, **kwargs):
        r"""
        Returns:
            :obj:`tuple(tf.Tensor)` comprising various elements depending on the configuration (:class:`~transformer.AlbertConfig`) and inputs:
        ...
        Examples::
            ...
            import tensorflow as tf
            from transformer import AlbertTokenizer, TFAlbertModel
...
class TFAlbertForMaskedLM(TFAlbertPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from transformer import AlbertTokenizer, TFAlbertForMaskedLM
...
class TFAlbertForSequenceClassification(TFAlbertPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from transformer import AlbertTokenizer, TFAlbertForSequenceClassification
