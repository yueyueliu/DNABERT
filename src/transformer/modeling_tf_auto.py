...
class TFAutoModel(object):
    r"""
        :class:`~transformer.TFAutoModel` is a generic model class
...
class TFAutoModelForPreTraining(object):
    r"""
        :class:`~transformer.TFAutoModelForPreTraining` is a generic model class
    ...
    def from_config(cls, config):
        ...
        Args:
            config (:class:`~transformers.PretrainedConfig`):
                ...
                - isInstance of `distilbert` configuration class: :class:`~transformer.TFDistilBertModelForMaskedLM` (DistilBERT model)
                - isInstance of `roberta` configuration class: :class:`~transformer.TFRobertaModelForMaskedLM` (RoBERTa model)
                - isInstance of `bert` configuration class: :class:`~transformer.TFBertForPreTraining` (Bert model)
                - isInstance of `openai-gpt` configuration class: :class:`~transformer.TFOpenAIGPTLMHeadModel` (OpenAI GPT model)
                - isInstance of `gpt2` configuration class: :class:`~transformer.TFGPT2ModelLMHeadModel` (OpenAI GPT-2 model)
                - isInstance of `ctrl` configuration class: :class:`~transformer.TFCTRLModelLMHeadModel` (Salesforce CTRL  model)
                - isInstance of `transfo-xl` configuration class: :class:`~transformer.TFTransfoXLLMHeadModel` (Transformer-XL model)
                - isInstance of `xlnet` configuration class: :class:`~transformer.TFXLNetLMHeadModel` (XLNet model)
                - isInstance of `xlm` configuration class: :class:`~transformer.TFXLMWithLMHeadModel` (XLM model)
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        The model class to instantiate is selected as the first pattern matching
        in the `pretrained_model_name_or_path` string (in the following order):
            - contains `t5`: :class:`~transformer.TFT5ModelWithLMHead` (T5 model)
            - contains `distilbert`: :class:`~transformer.TFDistilBertForMaskedLM` (DistilBERT model)
            - contains `albert`: :class:`~transformer.TFAlbertForMaskedLM` (ALBERT model)
            - contains `roberta`: :class:`~transformer.TFRobertaForMaskedLM` (RoBERTa model)
            - contains `bert`: :class:`~transformer.TFBertForPreTraining` (Bert model)
            - contains `openai-gpt`: :class:`~transformer.TFOpenAIGPTLMHeadModel` (OpenAI GPT model)
            - contains `gpt2`: :class:`~transformer.TFGPT2LMHeadModel` (OpenAI GPT-2 model)
            - contains `transfo-xl`: :class:`~transformer.TFTransfoXLLMHeadModel` (Transformer-XL model)
            - contains `xlnet`: :class:`~transformer.TFXLNetLMHeadModel` (XLNet model)
            - contains `xlm`: :class:`~transformer.TFXLMWithLMHeadModel` (XLM model)
            - contains `ctrl`: :class:`~transformer.TFCTRLLMHeadModel` (Salesforce CTRL model)
...
class TFAutoModelWithLMHead(object):
    r"""
        :class:`~transformer.TFAutoModelWithLMHead` is a generic model class
...
class TFAutoModelForSequenceClassification(object):
    r"""
        :class:`~transformer.TFAutoModelForSequenceClassification` is a generic model class
...
class TFAutoModelForQuestionAnswering(object):
    r"""
        :class:`~transformer.TFAutoModelForQuestionAnswering` is a generic model class
