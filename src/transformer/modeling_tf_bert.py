...
BERT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformer.BertConfig`): Model configuration class with all the parameters of the model.
...
class TFBertModel(TFBertPreTrainedModel):
    ...
    def call(self, inputs, **kwargs):
        r"""
        Returns:
        :obj:`tuple(torch.FloatTensor)` comprising various elements depending on the configuration (:class:`~transformer.BertConfig`) and inputs:
...
class TFBertForPreTraining(TFBertPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from transformer import BertTokenizer, TFBertForPreTraining
...
class TFBertForMaskedLM(TFBertPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from transformer import BertTokenizer, TFBertForMaskedLM
...
class TFBertForNextSentencePrediction(TFBertPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from transformer import BertTokenizer, TFBertForNextSentencePrediction
...
class TFBertForMultipleChoice(TFBertPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from transformer import BertTokenizer, TFBertForMultipleChoice
...
class TFBertForTokenClassification(TFBertPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from transformer import BertTokenizer, TFBertForTokenClassification
...
class TFBertForQuestionAnswering(TFBertPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from transformer import BertTokenizer, TFBertForQuestionAnswering
