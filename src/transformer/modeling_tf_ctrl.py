...
class TFCTRLModel(TFCTRLPreTrainedModel):
    ...
    def call(self, inputs, **kwargs):
        r"""
    Return:
        :obj:`tuple(tf.Tensor)` comprising various elements depending on the configuration (:class:`~transformer.CTRLConfig`) and inputs:
    ...
    Examples::
        ...
        import tensorflow as tf
        from transformer import CTRLTokenizer, TFCTRLModel
...
class TFCTRLLMHeadModel(TFCTRLPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from transformer import CTRLTokenizer, TFCTRLLMHeadModel
