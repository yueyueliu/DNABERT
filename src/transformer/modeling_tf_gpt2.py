...
GPT2_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformer.GPT2Config`): Model configuration class with all the parameters of the model.
...
class TFGPT2Model(TFGPT2PreTrainedModel):
    ...
    def call(self, inputs, **kwargs):
        r"""
    Return:
        :obj:`tuple(tf.Tensor)` comprising various elements depending on the configuration (:class:`~transformer.GPT2Config`) and inputs:
    ...
    Examples::
        ...
        import tensorflow as tf
        from transformer import GPT2Tokenizer, TFGPT2Model
...
class TFGPT2LMHeadModel(TFGPT2PreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from transformer import GPT2Tokenizer, TFGPT2LMHeadModel
...
class TFGPT2DoubleHeadsModel(TFGPT2PreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from transformer import GPT2Tokenizer, TFGPT2DoubleHeadsModel
