...
T5_START_DOCSTRING = r"""    The T5 model was proposed in
    ...
    Parameters:
        config (:class:`~transformer.T5Config`): Model configuration class with all the parameters of the model.
...
T5_INPUTS_DOCSTRING = r"""
    Inputs:
        **input_ids**: ``Numpy array`` or ``tf.Tensor`` of shape ``(batch_size, sequence_length)``:
            ...
            Indices can be obtained using :class:`transformer.T5Tokenizer`.
            See :func:`transformer.PreTrainedTokenizer.encode` and
            :func:`transformer.PreTrainedTokenizer.convert_tokens_to_ids` for details.
...
class TFT5Model(TFT5PreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from transformer import T5Tokenizer, TFT5Model
...
class TFT5WithLMHeadModel(TFT5PreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from transformer import T5Tokenizer, TFT5WithLMHeadModel
