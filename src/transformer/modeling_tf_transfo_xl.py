...
TRANSFO_XL_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformer.TransfoXLConfig`): Model configuration class with all the parameters of the model.
...
TRANSFO_XL_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`tf.Tensor` or :obj:`Numpy array` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`transformer.TransfoXLTokenizer`.
...
class TFTransfoXLModel(TFTransfoXLPreTrainedModel):
    ...
    def call(self, inputs, **kwargs):
        r"""
    Return:
        :obj:`tuple(torch.FloatTensor)` comprising various elements depending on the configuration (:class:`~transformer.TransfoXLConfig`) and inputs:
    ...
    Examples::
        ...
        import tensorflow as tf
        from transformer import TransfoXLTokenizer, TFTransfoXLModel
...
class TFTransfoXLLMHeadModel(TFTransfoXLPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from transformer import TransfoXLTokenizer, TFTransfoXLLMHeadModel
