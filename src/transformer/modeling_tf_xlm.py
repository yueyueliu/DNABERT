...
class TFXLMModel(TFXLMPreTrainedModel):
    ...
    def call(self, inputs, **kwargs):
        r"""
    Return:
        :obj:`tuple(tf.Tensor)` comprising various elements depending on the configuration (:class:`~transformer.XLMConfig`) and inputs:
    ...
    Examples::
        ...
        import tensorflow as tf
        from transformer import XLMTokenizer, TFXLMModel
...
class TFXLMWithLMHeadModel(TFXLMPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from transformer import XLMTokenizer, TFXLMWithLMHeadModel
...
class TFXLMForSequenceClassification(TFXLMPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from transformer import XLMTokenizer, TFXLMForSequenceClassification
...
class TFXLMForQuestionAnsweringSimple(TFXLMPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from transformer import XLMTokenizer, TFXLMForQuestionAnsweringSimple
