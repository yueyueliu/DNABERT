...
XLM_ROBERTA_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformer.XLMRobertaConfig`): Model configuration class with all the parameters of the
...
class XLMRobertaModel(RobertaModel):
    """
    This class overrides :class:`~transformer.RobertaModel`. Please check the
...
class XLMRobertaForMaskedLM(RobertaForMaskedLM):
    """
    This class overrides :class:`~transformer.RobertaForMaskedLM`. Please check the
    superclass for the appropriate documentation alongside usage examples.
    """
...
class XLMRobertaForSequenceClassification(RobertaForSequenceClassification):
    """
    This class overrides :class:`~transformer.RobertaForSequenceClassification`. Please check the
    superclass for the appropriate documentation alongside usage examples.
    """
...
class XLMRobertaForMultipleChoice(RobertaForMultipleChoice):
    """
    This class overrides :class:`~transformer.RobertaForMultipleChoice`. Please check the
    superclass for the appropriate documentation alongside usage examples.
    """
...
class XLMRobertaForTokenClassification(RobertaForTokenClassification):
    """
    This class overrides :class:`~transformer.RobertaForTokenClassification`. Please check the
    superclass for the appropriate documentation alongside usage examples.
    """
