...
class AutoTokenizer:
    r""":class:`~transformer.AutoTokenizer` is a generic tokenizer class
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *inputs, **kwargs):
        ...
        Params:
            ...
            use_fast: (`optional`) boolean, default True:
                Indicate if transformer should try to load the fast version of the tokenizer (True) or use the Python one (False).
